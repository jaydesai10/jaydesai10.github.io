...
The second is to take a model independent approach and let experiments guide your way. The way to do the latter in a quantum field theoretic framework is to use the extremely powerful tool
...
We have focused on a subset motivated by a physical hypothesis where NP only couples to the bosonic particles or universally via SM currents. Theories that describe this phenomena are known as “Universal” and they restrict the parameter
space of SMEFT quite significantly. 
